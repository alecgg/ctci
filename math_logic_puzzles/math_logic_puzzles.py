...
# 1.1 grams.  Given a scale that provides an exact measurement, how would you find th heavy bottle.
...
# else they face massive fines.  If all families abide by this policy--that is, they continue to have
...
# it takes seven days to return a result.  How would you figure out th poisoned bottle in as few days as
# possible?
# FOLLOW UP
